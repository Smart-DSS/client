...
export default function BottleneckPlotComponent() {
  ...
  useEffect(() => {
    ...
    const fetchPlot = () => {
      // fetch('https://test-223005939796.asia-south1.run.app/bottleneck')
  ...
  return (
    <div>
      <h1 className="bg-gray-50 px-2 py-1 rounded-full">
        Bottle Neck Plot Display
      </h1>
      {plotUrl ? <img src={plotUrl} alt="Plot" /> : <p>Loading plot...</p>}
      {/* <Image
        src="/BottleneckPlotComponent.png" // or use an external URL
