...
const LocationCards = () => {
  return (
    <div className="w-full h-full max-h-[350px] md:max-h-[350px] flex flex-col m-2 p-2 rounded-lg bg-white shadow-[4px_8px_15px_#00000040]">
      {/* <button className="w-[95%] m-2 p-3 bg-[#f1f1f1] text-gray-800 border-none rounded-md cursor-pointer transition-all hover:bg-gray-300 transform hover:scale-95">
      ...
      <div className="flex-1 overflow-y-auto pr-1">
        <div className="bg-[#f1f1f1] my-1.5 p-4 rounded-lg transition-transform transform hover:scale-95 cursor-pointer">
