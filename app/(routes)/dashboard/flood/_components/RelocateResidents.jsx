...
//         // Update the document to set isNotOnAlert to false
//         updatePromises.push(updateDoc(docRef, { isNotOnAlert: false }));
  
//         // Send push notification using FCM
//         notificationPromises.push(sendPushNotification(data.fcmtoken));
//       });
...
//         },
//         body: JSON.stringify({
//           // The server-side function will handle accessToken
//           token: fcmtoken,
//           title: "Nirnai Alert",
//           body: "This is an Alert notification message!",
//         }),
...
//             <div className="flex flex-col justify-center p-3 gap-4">
//               <div className="font-extralight text-sm">
//                 To notify app users about relocating to their nearest assigned shelter, please click the button below.
//               </div>
//               <button
//                 onClick={notifyResidents}
//                 className="bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition duration-300 ease-in-out"
